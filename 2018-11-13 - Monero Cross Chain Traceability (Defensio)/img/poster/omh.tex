...
\begin{scope}[xshift=-3.6cm]
    \node[text=white] (TX2) at (-2.25,1){TX1};
    \node[virNode=0.450] (X3) at (-1,1){O1}; 

    \node[text=white] (TX1) at (-2.25,-0.5){TX2};
    \node[virNode=0.525] (X1) at (-1,0){O2}; 
    \node[virNode=0.600] (X2) at (-1,-1){O3}; 
    
    \node[text=white] (TX3) at (-2.25,-2){TX3};
    \node[virNode=0.675] (X4) at (-1,-2){O4}; 
    \node[virNode=0.25,text=white] (Y1) at (1,0){R1};
    \node[virNode=0.30,text=white] (Y2) at (1,-1){R2};
    
    \node[text=white] (TX4) at (1.75,0.75){TX4};
    \node[virNode=0.63] (Y3) at (2.25,0){O5};
    \node[virNode=0.67] (Y4) at (2.25,-1){O6};
